...
public abstract class HttpAsyncTask<Params, Progress, Result> {
	 ...
	 */
	public static final Executor THREAD_POOL_EXECUTOR = (ExecutorService) Executors.newFixedThreadPool(5);

	/**
	 * An {@link Executor} that executes tasks one at a time in serial order.
	 * This serialization is global to a particular process.
	 */
	public static final Executor SERIAL_EXECUTOR = THREAD_POOL_EXECUTOR;
